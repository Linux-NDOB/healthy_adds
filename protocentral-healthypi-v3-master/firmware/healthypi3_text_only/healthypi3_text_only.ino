...
// CODE MODIFIED BY: Linux-NDOB 
// For better Json data sending
    ...
    if(leadoff_deteted == true)
     ...
     int temperature =  (uint16_t) temp;
      ...
      if(millis() > print_time_elapsed )
      {
        ...
        {
          data["Heart Rate"] = global_HeartRate;
          
          data["Resp Rate"] = global_RespirationRate;
        }
